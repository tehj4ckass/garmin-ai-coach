    ...
    model_assignments: dict[AIMode, dict[AgentRole, str]] = field(
        default_factory=lambda: {
            ...
            AIMode.COST_EFFECTIVE: {
                AgentRole.SUMMARIZER: "gpt-4o-mini",
                AgentRole.FORMATTER: "gpt-4o-mini",
                AgentRole.METRICS_EXPERT: "gpt-4o-mini",
                AgentRole.PHYSIOLOGY_EXPERT: "gpt-4o-mini",
                AgentRole.ACTIVITY_EXPERT: "gpt-4o-mini",
                AgentRole.SYNTHESIS: "gpt-4o-mini",
                AgentRole.WORKOUT: "gpt-4o-mini",
                AgentRole.SEASON_PLANNER: "gpt-4o-mini",
            },
            AIMode.STANDARD: {
