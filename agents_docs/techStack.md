...
### Supported Models
- **Anthropic Claude** - claude-sonnet-4, claude-opus-4 (with extended thinking support)
- **OpenAI** - gpt-5, gpt-5.2-pro, gpt-5-mini, gpt-5-search, gpt-5.2-pro-search (with web search), gpt-4o, gpt-4o-mini, o1, o3, o4-mini
